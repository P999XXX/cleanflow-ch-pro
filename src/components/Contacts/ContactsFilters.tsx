...
import { Search, X, Filter, Building2, Users, Plus, Grid3X3, List, User, Briefcase } from "lucide-react";
      ...
      <div className="flex flex-col space-y-4 px-4 lg:px-6">
        ...
        <div className="lg:hidden space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            {/* View toggle visible on tablet (md breakpoint) */}
            <Button
              variant="outline"
              size="sm"
        ...
        {/* Desktop Layout (above lg breakpoint) */}
